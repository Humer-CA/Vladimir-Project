      ...
      const exportData = res.data.map((item) => {
        ...
        return {
          ...
          "Vladimir Tag Number":
            ...
            (item.add_cost_sequence === null
              ? ""
              : `-${item.add_cost_sequence}`),
          ...
          "Acquisition Date": moment(item.acquisition_date).format(
            "MMM DD, YYYY"
          ),
          ...
          "Start Depreciation": moment(item.start_depreciation).format(
            "MMM DD, YYYY"
          ),
          "End Depreciation": moment(item.end_depreciation).format(
            "MMM DD, YYYY"
          ),
