...
import FaStatusChange from "../../../../Components/Reusable/FaStatusChange";
...
const FixedAssetView = (props) => {
  ...
  const [patchFixedAssetStatusApi, { isLoading: isPatchLoading }] =
    useArchiveFixedAssetStatusApiMutation();

  const [patchAdditionalCostStatusApi, { isLoading: isAdditionalCostLoading }] =
  ...
  const isLocalIp =
    ...
    `http://127.0.0.1:8000/VladimirPrinting/public/index.php/api`;
  ...
  return (
    <>
      {dataApiLoading && (
        <FixedAssetViewSkeleton onAdd={true} onImport={true} onPrint={true} />
      )}
      ...
      {dataApi && !dataApiError && (
        <Box className="tableCard">
                ...
                <Button
                  ...
                  startIcon={
                    isSmallScreen ? null : (
                      <PriceChange
                        color={
                          dataApi.data?.depreciation_status
                            ?.depreciation_status_name !== "For Depreciation" &&
          ...
          <Box className="tableCard__container">
            <Box>
              <Card
                className="tableCard__cardCapex"
              ...
              <Accordion>
                ...
                <AccordionDetails className="tableCard__border">
                  ...
                  <Box className="tableCard__properties">
                    ...
                    <Typography className="tableCard__info" fontSize="14px">
                      {
                        dataApi?.data?.cycle_count_status
                  ...
                  {dataApi?.data?.additional_cost?.length === 0 ? (
                    ...
                    <>
                      <TableContainer>
                        <Table>
                          <TableBody>
                            {dataApi.data.additional_cost?.map(
                              (mapData, index) => {
                                return (
                                  <TableRow
                                    key={index}
                                  ...
                                  >
                                    ...
                                    <TableCell align="center">
                                      <FaStatusChange
                                        faStatus={
                                          mapData.asset_status.asset_status_name
                                        }
                                        data={
                                          mapData.asset_status.asset_status_name
                                        }
