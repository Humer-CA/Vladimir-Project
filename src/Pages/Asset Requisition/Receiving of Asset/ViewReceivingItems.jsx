  ...
  return (
    <>
      ...
      <TablePagination
        ...
        component="div"
        count={receivingSuccess ? receivingData?.total : 0}
        page={receivingSuccess ? receivingData?.current_page - 1 : 0}
        rowsPerPage={receivingSuccess ? parseInt(receivingData?.per_page) : 5}
