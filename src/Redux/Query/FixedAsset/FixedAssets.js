...
export const fixedAssetApi = createApi({
    ...
    endpoints: (builder) => ({
        getFixedAssetApi: builder.query({
            query: (params) => `fixed-asset-search?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
            // query: (params) => `fixed-assets/search?search=${params.search}&page=${params.page}&limit=${params.limit}`,
        ...
        getPrintViewingApi: builder.query({
            query: (params) => {
                const queryParams = [`search=${params.search}`, `limit=${params.limit}`, `page=${params.page}`];
...
export const { useGetFixedAssetApiQuery, useGetFixedAssetAllApiQuery, useGetFixedAssetIdApiQuery, useArchiveFixedAssetStatusApiMutation, usePostFixedAssetApiMutation, useUpdateFixedAssetApiMutation, usePostImportApiMutation, useLazyGetExportApiQuery, usePostPrintApiMutation, usePostLocalPrintApiMutation, usePostCalcDepreApiMutation, useGetPrintViewingApiQuery } = fixedAssetApi