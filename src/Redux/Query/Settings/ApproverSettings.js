...
export const approverSettingsApi = createApi({
    ...
    endpoints: (builder) => ({
        getApproverSettingsApi: builder.query({
            query: (params) => `approver-setting?search=${params.search}&limit=${params.limit}&status=${params.status}&page=${params.page}`,
            providesTags: ["ApproverSettings"]
        }),

        getApproverSettingsAllApi: builder.query({
            query: () => `approver-setting`,
...
export const { useGetApproverSettingsApiQuery, useGetApproverSettingsAllApiQuery, 
    // useGetApproverSettingsIdApiQuery,
     usePostApproverSettingsStatusApiMutation, usePostApproverSettingsApiMutation, useUpdateApproverSettingsApiMutation, useGetApproversApiQuery } = approverSettingsApi