...
export const subCapexApi = createApi({
    ...
    endpoints: (builder) => ({
        getSubCapexApi: builder.query({
            query: (params) => `sub-capex?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetSubCapexApiQuery, useGetSubCapexAllApiQuery, useGetSubCapexIdApiQuery, usePostSubCapexApiMutation, useUpdateSubCapexApiMutation } = subCapexApi