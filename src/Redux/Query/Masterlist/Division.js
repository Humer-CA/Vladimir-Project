...
export const divisionApi = createApi({
    ...
    endpoints: (builder) => ({
        getDivisionApi: builder.query({
            query: (params) => `divisions/search?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetDivisionApiQuery, useGetDivisionAllApiQuery, useGetDivisionIdApiQuery, usePostDivisionStatusApiMutation, usePostDivisionApiMutation, useUpdateDivisionApiMutation } = divisionApi