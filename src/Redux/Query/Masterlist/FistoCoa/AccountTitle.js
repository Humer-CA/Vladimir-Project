...
export const accountTitleApi = createApi({
    ...
    endpoints: (builder) => ({
        getAccountTitleApi: builder.query({
            query: (params) => `/account-titles/search?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetAccountTitleApiQuery, useGetAccountTitleAllApiQuery, usePostAccountTitleApiMutation, usePatchAccountTitleStatusApiMutation } = accountTitleApi