...
export const capexApi = createApi({
    ...
    endpoints: (builder) => ({
        getCapexApi: builder.query({
            query: (params) => `capex?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
            providesTags: ["Capex"]
        }),
...
export const { useGetCapexApiQuery, useGetCapexAllApiQuery, useLazyGetCapexAllApiQuery,useGetCapexIdApiQuery, usePatchCapexStatusApiMutation, usePostCapexApiMutation, useUpdateCapexApiMutation, usePostImportApiMutation, usePostSubCapexApiMutation, useUpdateSubCapexApiMutation, usePatchSubCapexStatusApiMutation, useLazyGetExportApiQuery } = capexApi