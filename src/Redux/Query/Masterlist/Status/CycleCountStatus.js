...
export const cycleCountStatusApi = createApi({
    ...
    endpoints: (builder) => ({
        getCycleCountStatusApi: builder.query({
            query: (params) => `cycle-count-status?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetCycleCountStatusApiQuery, useGetCycleCountStatusAllApiQuery, useGetCycleCountStatusIdApiQuery, usePatchCycleCountStatusStatusApiMutation, usePostCycleCountStatusApiMutation, useUpdateCycleCountStatusApiMutation } = cycleCountStatusApi