...
export const depreciationStatusApi = createApi({
    ...
    endpoints: (builder) => ({
        getDepreciationStatusApi: builder.query({
            query: (params) => `depreciation-status?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetDepreciationStatusApiQuery, useGetDepreciationStatusAllApiQuery, useGetDepreciationStatusIdApiQuery, usePatchDepreciationStatusStatusApiMutation, usePostDepreciationStatusApiMutation, useUpdateDepreciationStatusApiMutation } = depreciationStatusApi