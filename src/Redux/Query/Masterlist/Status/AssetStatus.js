...
export const assetStatusApi = createApi({
    ...
    endpoints: (builder) => ({
        getAssetStatusApi: builder.query({
            query: (params) => `asset-status?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetAssetStatusApiQuery, useGetAssetStatusAllApiQuery, useGetAssetStatusIdApiQuery, usePatchAssetStatusStatusApiMutation, usePostAssetStatusApiMutation, useUpdateAssetStatusApiMutation } = assetStatusApi