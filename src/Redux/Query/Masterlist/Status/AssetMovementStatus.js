...
export const assetMovementStatusApi = createApi({
    ...
    endpoints: (builder) => ({
        getAssetMovementStatusApi: builder.query({
            query: (params) => `movement-status?search=${params.search}&page=${params.page}&limit=${params.limit}&status=${params.status}`,
...
export const { useGetAssetMovementStatusApiQuery, useGetAssetMovementStatusAllApiQuery, useGetAssetMovementStatusIdApiQuery, usePatchAssetMovementStatusStatusApiMutation, usePostAssetMovementStatusApiMutation, useUpdateAssetMovementStatusApiMutation } = assetMovementStatusApi