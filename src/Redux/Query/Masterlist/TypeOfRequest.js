...
export const typeOfRequestApi = createApi({
    ...
    endpoints: (builder) => ({
        getTypeOfRequestApi: builder.query({
            query: (params) => `type-of-request?search=${params.search}&limit=${params.limit}&status=${params.status}&page=${params.page}`,
...
export const { useGetTypeOfRequestApiQuery, useGetTypeOfRequestAllApiQuery, useGetTypeOfRequestIdApiQuery, usePostTypeOfRequestStatusApiMutation, usePostTypeOfRequestApiMutation, useUpdateTypeOfRequestApiMutation } = typeOfRequestApi