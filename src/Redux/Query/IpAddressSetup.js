...
export const ipAddressSetupApi = createApi({
    ...
    endpoints: (builder) => ({
        getIpAddressApi: builder.query({
            query: (params) => `/printer-ip?search=${params.search}&page=${params.page}&limit=${params.limit}`,
            providesTags: ["Ip"]
        }),
...
export const { useGetIpAddressApiQuery, useGetIpApiQuery, usePatchIpAddressStatusApiMutation, useGetIpAddressAllApiQuery, usePostIpAddressApiMutation, useDeleteIpAddressApiMutation } = ipAddressSetupApi
